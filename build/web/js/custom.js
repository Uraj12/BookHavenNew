    ...
    jQuery(document).ready(function () {
        ...
        jQuery(document).ready(function () {
            jQuery(document).on('click', '.qty-btn', function () {
                var $quantityInput = jQuery(this).siblings('input[type="text"]');
                ...
                if (jQuery(this).hasClass('fa-minus')) {
                    ...
                    if (val < 12) {
                        ...
                        $quantityInput.val(12);
                    }
                }

                // Calculate total price and update HTML
                var quantity = parseInt($quantityInput.val());
                var price = parseFloat(jQuery(this).closest('.checkout-product').find('.product-price').text().replace('$', ''));
                var totalPrice = quantity * price;

                jQuery(this).closest('.checkout-product').find('.price h5').text('$' + totalPrice.toFixed(2));
            });
        });
